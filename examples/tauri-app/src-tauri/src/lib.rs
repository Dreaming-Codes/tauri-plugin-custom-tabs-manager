...
use tauri_plugin_custom_tabs_manager::{CustomTabsManagerExt, MayLaunchUrlRequest, OpenCustomTabSimpleRequest};
...
pub fn run() {
    tauri::Builder::default()
        ...
        .setup(move |app| {
            app.app_handle().custom_tabs_manager().may_launch_url(MayLaunchUrlRequest {
